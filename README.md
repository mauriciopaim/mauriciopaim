...
| `merged` | [Use --mouse=uhid so control works on devices that block INJECT_EVENTS](https://github.com/AdamMusa/omarchy-phone/pull/2) | [omarchy-phone](https://github.com/AdamMusa/omarchy-phone)<br><sub>5 stars</sub> |
